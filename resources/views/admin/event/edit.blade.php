                ...
                <form action="/event/{{$event->id}}" method="post" >
                    <div class="row">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="date" name="starting_at" class="form-control" value="{{$event->starting_at}}">
                        </div>
                        <div class="col-lg-4 form-group">
                            <label>End Date*</label>
                            <input type="date" name="ending_at" class="form-control" value="{{$event->ending_at}}">
                        </div>
                        <div class="col-lg-4 form-group">
                            <label>Reg Fees in Rupees*</label>
                            <input type="number" name="regFee" class="form-control" value="{{$event->regFee}}">
                        </div>
