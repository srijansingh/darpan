                ...
                @endif
                    ...
                    <form action="/event" method="post" >
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="date" name="starting_at" class="form-control">
                        </div>
                        <div class="col-lg-4 form-group">
                            <label>End Date*</label>
                            <input type="date" name="ending_at" class="form-control">
                        </div>
                        <div class="col-lg-4 form-group">
                    ...
                    <div class=" form-group">
                        <input type="submit" name="pic" class="btn btn-primary" value="Create Event" style="float:right;">
                    </div>
            </div>
                </form>
