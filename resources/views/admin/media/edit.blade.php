    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Add Social Media Links</h1>


                <form action="/media/{{$link->id}}" method="post" >
                    <div class="column">
                        @csrf
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{$link->facebook}}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>Instagram</label>
                            <input type="text" name="name" class="form-control" value="{{$link->instagram}}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>Twitter</label>
                            <input type="text" name="name" class="form-control" value="{{$link->twitter}}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>LinkedIn</label>
                            <input type="text" name="name" class="form-control" value="{{$link->linkedin}}">
                        </div>



                        <div class=" form-group">
                            <input type="submit" name="pic" class="btn btn-primary" value="Update Now" style="margin:0px 10px">
                        </div>
                    </div>
                </form>
